// local imgs
const Onboarding = require("../assets/imgs/profile-screen-bg.jpeg");
const Logo = require("../assets/imgs/app-logo.png");
const LogoOnboarding = require("../assets/imgs/app-logo.png");
const ProfileBackground = require("../assets/imgs/profile-screen-bg.jpeg");
const RegisterBackground = require("../assets/imgs/register-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const AlerttmeeLogo = require("../assets/imgs/app-logo.png");
