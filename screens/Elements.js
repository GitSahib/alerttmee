...
// Alerttmee themed components
import { alerttmeeTheme, tabs } from "../constants/";
      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Text
            ...
            color={alerttmeeTheme.COLORS.DEFAULT}
          >
            Heading 1
          </Text>
          <Text
      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Input
            ...
            style={{
              borderColor: alerttmeeTheme.COLORS.INFO,
              borderRadius: 4,
              backgroundColor: "#fff",
            }}
            iconContent={<Block />}
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: alerttmeeTheme.COLORS.INPUT_SUCCESS,
                }}
              >
                <Icon
                  size={11}
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: alerttmeeTheme.COLORS.INPUT_ERROR,
                }}
              >
                <Icon
                  size={11}
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header
              ...
              bgColor={alerttmeeTheme.COLORS.ACTIVE}
              titleColor="white"
              iconColor="white"
            />
          </Block>
...
const styles = StyleSheet.create({
  ...
  inputDefault: {
    borderBottomColor: alerttmeeTheme.COLORS.PLACEHOLDER,
  },
  inputTheme: {
    borderBottomColor: alerttmeeTheme.COLORS.PRIMARY,
  },
  inputInfo: {
    borderBottomColor: alerttmeeTheme.COLORS.INFO,
  },
  inputSuccess: {
    borderBottomColor: alerttmeeTheme.COLORS.SUCCESS,
  },
  inputWarning: {
    borderBottomColor: alerttmeeTheme.COLORS.WARNING,
  },
  inputDanger: {
    borderBottomColor: alerttmeeTheme.COLORS.ERROR,
  },
  social: {
