      ...
      <Block flex style={styles.container}>
        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              <Block>
                <Image source={Images.AlerttmeeLogo}
                  style={{ marginBottom: theme.SIZES.BASE * 1.5 }}/>
              </Block>
              <Block >
                <Block>
                  <Text color="white" size={60}>Alerttmee</Text>
                </Block>
                <Block>
              ...
              <Button
                shadowless
                style={styles.button}
                color={alerttmeeTheme.COLORS.INFO}
                onPress={() => Linking.openURL('https://www.creative-tim.com/product/alerttmee-pro-react-native').catch((err) => console.error('An error occurred', err))}>
...
const styles = StyleSheet.create({
  ...
  pro: {
    backgroundColor: alerttmeeTheme.COLORS.INFO,
    paddingHorizontal: 8,
    marginLeft: 3,
    borderRadius: 4,
    height: 22,
